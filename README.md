...
|                                                                  |                                               |                                         |
| ---------------------------------------------------------------- | --------------------------------------------- | --------------------------------------- |
| **机体 / 单位界面** 机体名 · 武器 · 特殊防御 · 特殊能力 | **战斗界面** 武器 · 指令 · 驾驶员信息 | **剧情关卡** 过场对话 · 剧情旁白 |
...
|                                                                         |                                                                           |
| ----------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| **精神感应高达 → 精神力高达** 系列译名订正（含 MKⅡ 形态）       | **W高达零式(EW) → 零式飞翼高达EW** 与其它零式变体区分              |
| **灵格斯／BWS → 灵格斯(BWS)** 变体后缀改用半角括号，列表单行显示 | **斯摩／银色型 → 斯摩(银色型)** 变体后缀改用半角括号，列表单行显示 |
...
|                                                                         |                                                                            |
| ----------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| **剧情 / 补充 · 作战简报** · 每关的简报正文（作戦内容）逐段还原 | **剧情对话** · 按游戏内演出顺序、含说话人（如「相遇的宇宙」220 段） |
...
|                                                                       |                                                                 |
| --------------------------------------------------------------------- | --------------------------------------------------------------- |
| **角色 · ID/名台词** · 指令名 · 效果名 · 效果说明 · 名台词 | **机体 · 武器/效果** · 各武器名 · 特殊能力 · 特殊防御 |
...
|                                               |                                                 |                                                 |
| --------------------------------------------- | ----------------------------------------------- | ----------------------------------------------- |
| **剧情对话** 关卡过场对话（WQY 新字库） | **ID指令页面** 指令名 · 使用条件 · 效果 | **必杀技名台词** 战斗过场 · 驾驶员名台词 |
...
**编成 · 配属界面** —— 每艘战舰可搭载 **6 机**（永恒号搭载数已由 2 提升至标准的 6）
...
|                                                         |                                                                        |
| ------------------------------------------------------- | ---------------------------------------------------------------------- |
| **机体开发 / 改造系统树** · 真·像素原图，可交互 | **关卡详情面板** · 我方 / 援军 / 敌方 / 攻略要点 / 隐藏加入条件 |
